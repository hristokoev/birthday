import { formDataAdd, formJump } from "../../store";
...
export default function NotComing() {
	...
	return (
		<div className="flex flex-col items-center justify-center text-center gap-4 rounded-2xl">
			...
			<button className="min-w-56 px-6 py-3 flex items-center text-lg font-extrabold uppercase rounded-2xl bg-[linear-gradient(to_right,#FF965A,#FF4343,#FF4343,#FF965A)] bg-[length:200%_auto] hover:animate-gradient focus:outline-none focus:ring-2 focus:ring-indigo-500 group/button" onClick={() => onSubmit()}>
